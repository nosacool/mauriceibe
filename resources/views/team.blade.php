...
<body>
    ...
    <div id="wrapper">
        ...
        <!-- Section Team -->
        <section class="tf-section section-team s1 background-section">
            <div class="container">
                <div class="intro">
                    ...
                    <h3 class="title wow" data-splitting>Donate To <br>People In Our Team.</h3>
                </div>
                <div class="main-team">
                    <div class="list-team-box">
                        <div class="box-item wow fadeInUp">
                            ...
                            <a href="#" class="info"><i class="icofont-facebook"></i></a>
                            <h5 class="name">Kamrul Islam</h5>
                    ...
                    <div class="list-team-box">
                        ...
                        <div class="box-item wow fadeInUp" data-wow-delay="1200ms">
                            <div class="img-box">
                                <img src="images/team/team-08.png" alt="">
                            </div>
                            <a href="#" class="info"><i class="icofont-facebook"></i></a>
                            <h5 class="name">Monika Mona</h5>
                            <p class="category">Exclusive at UX/UI</p>
                        </div>
                    </div>
                    <div class="themesflat-spacer clearfix" data-desktop="50" data-mobile="50" data-smobile="0"></div>
                    <div class="list-team-box">
                        <div class="box-item wow fadeInUp">
                            <div class="img-box">
                                <img src="images/team/team-09.png" alt="">
                            </div>
                            <a href="#" class="info"><i class="icofont-facebook"></i></a>
                            <h5 class="name">Robit Bonita</h5>
                            <p class="category">Exclusive at UX/UI</p>
                        </div>
                        <div class="box-item wow fadeInUp" data-wow-delay="400ms">
                            <div class="img-box">
                                <img src="images/team/team-10.png" alt="">
                            </div>
                            <a href="#" class="info"><i class="icofont-facebook"></i></a>
                            <h5 class="name">Jone Carten</h5>
                            <p class="category">Exclusive at UX/UI</p>
                        </div>
                        <div class="box-item wow fadeInUp" data-wow-delay="800ms">
                            <div class="img-box">
                                <img src="images/team/team-11.png" alt="">
                            </div>
                            <a href="#" class="info"><i class="icofont-facebook"></i></a>
                            <h5 class="name">Monika Mona</h5>
                            <p class="category">Exclusive at UX/UI</p>
                        ...
                        <div class="box-item wow fadeInUp" data-wow-delay="1200ms">
                            <div class="img-box">
                                <img src="images/team/team-12.png" alt="">
                            </div>
                            <a href="#" class="info"><i class="icofont-facebook"></i></a>
                            <h5 class="name">Robit Bonita</h5>
                            <p class="category">Exclusive at UX/UI</p>
